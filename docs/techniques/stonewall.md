...
The image below shows a Stonewall transaction as analyzed by [am-i.exposed](../advanced/check-privacy.md). Notice the 4 outputs with 2 being equal-value outputs, which mimics the appearance of a 2-party CoinJoin.
